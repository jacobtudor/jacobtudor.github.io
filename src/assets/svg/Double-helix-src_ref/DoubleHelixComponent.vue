<template>
    <div>
        <div class="helix" style="--total: 20">
            <div class="strand" style="--i:1">
                <div class="left">
                    <div class="dot"></div>
                    <div class="line"></div>
                </div>
